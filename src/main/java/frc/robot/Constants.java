...
public interface Constants {
    ...
    interface Swerve {
        ...
        COTSTalonFXSwerveConstants chosenModule =
                COTSTalonFXSwerveConstants.SDS.MK4i.KrakenX60(COTSTalonFXSwerveConstants.SDS.MK4i.driveRatios.L3); //edited
        ...
        interface Mod0 {
            ...
            int angleMotorID = 12;
            int canCoderID = 20;
            Rotation2d angleOffset = Rotation2d.fromDegrees(155.16);
        ...
        interface Mod1 {
            ...
            int angleMotorID = 4;
            int canCoderID = 1;
            Rotation2d angleOffset = Rotation2d.fromDegrees(172.44);
            SwerveModuleConstants constants =
                    new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        interface Mod2 {
            ...
            int angleMotorID = 10;
            int canCoderID = 21;
            Rotation2d angleOffset = Rotation2d.fromDegrees(110.16);
            SwerveModuleConstants constants =
                    new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        interface Mod3 {
            ...
            int angleMotorID = 6;
            int canCoderID = 2;
            Rotation2d angleOffset = Rotation2d.fromDegrees(77.76);
            SwerveModuleConstants constants =
                    new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
    }
    ...
    interface NotePlayerConstants {
        ...
        int INDEXER_MOTOR_ID = 17;

        int ARM_LEFT_MOTOR_ID = 15;
